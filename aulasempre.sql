...
-- Usuários de Escolas
(1, 'Renata Vasconcellos (Coordenação SP)', 'renata.coord@colegiosaopaulo.com.br', '$2b$10$Wyf.POt.yldTDEOdWPQaweuAjafC7.b/PmvYeaTbSdyARbHBFlr6S', '(11) 98765-1111', 'ESCOLA'),
(2, 'Carlos Eduardo (Diretor Dom Bosco)', 'carlos.direcao@domboscoedu.com.br', '$2b$10$Wyf.POt.yldTDEOdWPQaweuAjafC7.b/PmvYeaTbSdyARbHBFlr6S', '(11) 98765-2222', 'ESCOLA'),
(3, 'Mariana Fontes (RH Campinas)', 'mariana.rh@modernacampinas.com.br', '$2b$10$Wyf.POt.yldTDEOdWPQaweuAjafC7.b/PmvYeaTbSdyARbHBFlr6S', '(19) 98765-3333', 'ESCOLA'),
-- Usuários Professores
(NULL, 'Lucas Silva Martins', 'lucas.matematica@gmail.com', '$2b$10$Wyf.POt.yldTDEOdWPQaweuAjafC7.b/PmvYeaTbSdyARbHBFlr6S', '(11) 97111-0001', 'PROFESSOR'),
(NULL, 'Beatriz Albuquerque Lima', 'beatriz.letras@gmail.com', '$2b$10$Wyf.POt.yldTDEOdWPQaweuAjafC7.b/PmvYeaTbSdyARbHBFlr6S', '(11) 97222-0002', 'PROFESSOR'),
(NULL, 'Rodrigo Mendes de Oliveira', 'rodrigo.fisica@gmail.com', '$2b$10$Wyf.POt.yldTDEOdWPQaweuAjafC7.b/PmvYeaTbSdyARbHBFlr6S', '(11) 97333-0003', 'PROFESSOR'),
(NULL, 'Camila Rocha Nogueira', 'camila.historia@gmail.com', '$2b$10$Wyf.POt.yldTDEOdWPQaweuAjafC7.b/PmvYeaTbSdyARbHBFlr6S', '(19) 97444-0004', 'PROFESSOR'),
(NULL, 'Fernando Costa Guimarães', 'fernando.biologia@gmail.com', '$2b$10$Wyf.POt.yldTDEOdWPQaweuAjafC7.b/PmvYeaTbSdyARbHBFlr6S', '(11) 97555-0005', 'PROFESSOR');
